...
decision core is 158 tests with **no dependencies**. Optional features add 123
...
```sh
cargo test --features rest-catalog     # 287 tests, incl. a live REST catalog
...
src/
  ...
  cost.rs       one currency: bytes, cpu-seconds, waiting, money
